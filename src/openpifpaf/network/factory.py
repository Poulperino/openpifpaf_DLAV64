...
BASE_FACTORIES = {
    ...
    'resnet50dc5': lambda: basenetworks.ResnetDC5('resnet50dc5', torchvision.models.resnet50, dilation=True),
    'resnet50og': lambda: basenetworks.ResnetDC5('resnet50og', torchvision.models.resnet50, dilation=False),
